...
<body>
    ...
    <main>
            ...
            <table>
                ...
                <tbody>
                    <?php
                        ...
                        <th><a href="actualizar_Cliente.php?idCliente=<?php echo $dato->idCliente;?>" class="button">EDITAR</a></th>
                        <th><a href="../modelo/delete_Cliente.php?idCliente=<?php echo $dato->idCliente;?>" class="button">Eliminar</a></th>
                    </tr>
                    <?php
                        }
                    ?>
        ...
        <br>
        <a href="../pdf_Cliente.php" class="btn btn-primary" target="_blank">GENERAR REPORTE</a>
    </main>
    <footer id="pielogo">
        <div>
